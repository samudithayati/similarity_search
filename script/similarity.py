...
molecule_list=['[NH3+]Cc1ccc[nH+]c1']
fname='steve_1'
...
filename=fname+'_grover.pickle'

ss_grover=similarity_search(molecule_list,filename,DT_grover_data,grover_data,hoips_grover) 

# Chem.MolToSmiles(Chem.MolFromSmiles('[NH3+]CC1=C[NH+]=CC=C1'))
